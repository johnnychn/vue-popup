...
// 注册
    Vue.component('vue-popup', {
        ...
        '<div class="vue-popup-panel" :class="{\'vue-popup-shake-animation\':popup.shaking==true}" @click="panelClick()" :style="{background:contentBackground}" ><div :style="{color:titleColor,background:titleBackground,\'border-bottom\':titleBorderBottom}" class="vue-popup-title" v-show="hasTitle">{{title}}' +
